...
CFGVAR(Movement_AutoStrafe, true);
CFGVAR(Movement_AutoStrafe_TurnScale, 0.5f);
...
CFGVAR(ESP_ShowLocal, true);
CFGVAR(ESP_Box, true);
CFGVAR(ESP_Name, true);
CFGVAR(ESP_Conditions, true);
CFGVAR(ESP_Class, true);
...
CFGVAR(Glow_Enabled, true);
CFGVAR(Glow_EnemyOnly, true);
CFGVAR(Glow_ShowLocal, true);

CFGVAR(Chams_Enabled, true);
CFGVAR(Chams_EnemyOnly, true);
CFGVAR(Chams_ShowLocal, true);
...
CFGVAR(Colors_LocalColor, Color_t({ 235, 102, 255, 255 }));
...
CFGVAR(Colors_HealthPack, Color_t({ 121, 255, 80, 255}));
CFGVAR(Colors_AmmoPack, Color_t({ 214, 214, 214, 255}));
CFGVAR(Colors_ArmourPack, Color_t({ 70, 153, 255, 255}));
...
CFGVAR(Exploits_Anti_Knockback_Key, int(VK_LSHIFT));

CFGVAR(Visuals_Thirdperson_Key, int('B'));